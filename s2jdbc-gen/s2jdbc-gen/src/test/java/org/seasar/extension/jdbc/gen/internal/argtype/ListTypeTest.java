...
public class ListTypeTest {
    ...
    public void testToObject_stringValue() {
        List<? extends String> list = stringListType.toObject("['aaa','bbb']");
    ...
    public void testToObject_integerValue() {
        List<? extends Integer> list = numberListType.toObject("[1,2]");
        assertEquals(2, list.size());
    ...
    public void testToObject_empty() {
        List<? extends String> list = stringListType.toObject("[]");
