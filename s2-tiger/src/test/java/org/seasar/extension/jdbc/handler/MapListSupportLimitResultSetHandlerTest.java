 ...
 * 
 */
public class MapListSupportLimitResultSetHandlerTest extends TestCase {
    ...
    public void testHandle() throws Exception {
        MapListSupportLimitResultSetHandler handler = new MapListSupportLimitResultSetHandler(
