...
public class AutoSelectImplTest extends TestCase {
    ...
    public void testPrepareEntity_selectClause() {
        ...
        query.prepareEntity(entityMeta, tableAlias, propertyMapperList,
                idIndexList);
        assertEquals("T1_.ID S1_, T1_.NAME S2_, T1_.BBB_ID S3_, T1_.DTO S4_",
    ...
    public void testPrepareJoin_sql() throws Exception {
        ...
        query.prepareTarget();
        query.prepareJoin(new JoinMeta("bbb"));
        String expected = "select T1_.ID S1_, T1_.NAME S2_, T1_.BBB_ID S3_, T1_.DTO S4_, T2_.ID S5_, T2_.NAME S6_, T2_.CCC_ID S7_ from AAA T1_ left outer join BBB T2_ on T1_.BBB_ID = T2_.ID";
    ...
    public void testPrepareJoin_sql_mappedBy() throws Exception {
        ...
        query.prepareTarget();
        query.prepareJoin(new JoinMeta("aaa"));
        String expected = "select T1_.ID S1_, T1_.NAME S2_, T1_.CCC_ID S3_, T2_.ID S4_, T2_.NAME S5_, T2_.BBB_ID S6_, T2_.DTO S7_ from BBB T1_ left outer join AAA T2_ on T2_.BBB_ID = T1_.ID";
        assertEquals(expected, query.toSql());
    }
    ...
    public void testPrepareJoin_sql_nest() throws Exception {
        ...
        String expected = "select T1_.ID S1_, T1_.NAME S2_, T1_.BBB_ID S3_, T1_.DTO S4_, T2_.ID S5_, T2_.NAME S6_, T2_.CCC_ID S7_, T3_.ID S8_, T3_.NAME S9_ from AAA T1_ left outer join BBB T2_ on T1_.BBB_ID = T2_.ID left outer join CCC T3_ on T2_.CCC_ID = T3_.ID";
        assertEquals(expected, query.toSql());
    }
    ...
    public void testPrepareJoin_sql_condition() throws Exception {
        ...
        String expected = "select T1_.ID S1_, T1_.NAME S2_, T1_.BBB_ID S3_, T1_.DTO S4_, T2_.ID S5_, T2_.NAME S6_, T2_.CCC_ID S7_ from AAA T1_ left outer join BBB T2_ on T1_.BBB_ID = T2_.ID and T2_.ID = 100";
        assertEquals(expected, query.toSql());
    }
    ...
    public void testIdSql() {
        ...
        query.id(1);
        query.prepare("getResultList");
        assertEquals("select T1_.ID S1_, T1_.NAME S2_, T1_.BBB_ID S3_, T1_.DTO S4_ "
    ...
    public void testIdVersionSql() {
        ...
        query.prepare("getResultList");
        assertEquals(
                "select T1_.ID S1_, T1_.NAME S2_, T1_.LONG_TEXT S3_, T1_.FFF_ID S4_, T1_.VERSION S5_, T1_.LAST_UPDATED S6_ "
                        + "from EEE T1_ "
    ...
    public void testPrepareOrderBy_sql() {
        ...
        query.prepare("getResultList");
        assertEquals(
                "select T1_.ID S1_, T1_.NAME S2_, T1_.BBB_ID S3_, T1_.DTO S4_, T2_.ID S5_, T2_.NAME S6_, T2_.CCC_ID S7_ from AAA T1_ left outer join BBB T2_ on T1_.BBB_ID = T2_.ID order by T2_.ID desc",
                query.toSql());
    }
    ...
    public void testPrepareCriteria() {
        ...
        query.prepare("getResultList");
        assertEquals(
                "select T1_.ID S1_, T1_.NAME S2_, T1_.BBB_ID S3_, T1_.DTO S4_, T2_.ID S5_, T2_.NAME S6_, T2_.CCC_ID S7_ from AAA T1_ left outer join BBB T2_ on T1_.BBB_ID = T2_.ID where (T2_.ID = ?)",
                query.toSql());
    }
    ...
    public void testForUpdateSql() {
        ...
        query.prepare("getResultList");
        assertEquals(
                "select T1_.ID S1_, T1_.NAME S2_, T1_.BBB_ID S3_, T1_.DTO S4_, T2_.ID S5_, T2_.NAME S6_, T2_.CCC_ID S7_ "
                        + "from AAA T1_ "
                        + "left outer join BBB T2_ on T1_.BBB_ID = T2_.ID "
    ...
    public void testHint() {
        ...
        query.prepare("getResultList");
        assertEquals(
                "select /*+ index(T1_ index) */ T1_.ID S1_, T1_.NAME S2_, T1_.BBB_ID S3_, T1_.DTO S4_ "
    ...
    public void testHint_withJoin() {
        ...
        query.prepare("getResultList");
        assertEquals(
                "select /*+ index(T2_ index) */ T1_.ID S1_, T1_.NAME S2_, T1_.BBB_ID S3_, T1_.DTO S4_ "
