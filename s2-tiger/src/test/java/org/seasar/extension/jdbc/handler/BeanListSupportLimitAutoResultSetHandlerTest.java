 ...
 * 
 */
public class BeanListSupportLimitAutoResultSetHandlerTest extends TestCase {
    ...
    public void testHandle() throws Exception {
        ...
        BeanListSupportLimitAutoResultSetHandler handler = new BeanListSupportLimitAutoResultSetHandler(
