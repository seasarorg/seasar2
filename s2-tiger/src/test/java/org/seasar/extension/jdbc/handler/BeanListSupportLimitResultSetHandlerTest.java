 ...
 * 
 */
public class BeanListSupportLimitResultSetHandlerTest extends TestCase {
    ...
    public void testHandle() throws Exception {
		BeanListSupportLimitResultSetHandler handler = new BeanListSupportLimitResultSetHandler(
