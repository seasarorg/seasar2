 ...
 * 
 */
public class ObjectListSupportLimitResultSetHandlerTest extends TestCase {
    ...
    public void testHandle() throws Exception {
		ObjectListSupportLimitResultSetHandler handler = new ObjectListSupportLimitResultSetHandler(
