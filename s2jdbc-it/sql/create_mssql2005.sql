...
CREATE TABLE LARGE_OBJECT(ID NUMERIC(8) NOT NULL PRIMARY KEY, NAME VARCHAR(10), LARGE_NAME VARCHAR(MAX), BYTES VARBINARY(2000), LARGE_BYTES VARBINARY(MAX), DTO VARBINARY(2000), LARGE_DTO VARBINARY(MAX));
CREATE TABLE TENSE (ID INTEGER PRIMARY KEY,DATE_DATE DATETIME, DATE_TIME DATETIME, DATE_TIMESTAMP DATETIME, CAL_DATE DATETIME, CAL_TIME DATETIME, CAL_TIMESTAMP DATETIME, SQL_DATE DATETIME, SQL_TIME DATETIME, SQL_TIMESTAMP DATETIME);
