...
CREATE TABLE LARGE_OBJECT(ID INT NOT NULL PRIMARY KEY, NAME VARCHAR(10), LARGE_NAME VARCHAR(MAX), BYTES VARBINARY(2000), LARGE_BYTES VARBINARY(MAX), DTO VARBINARY(2000), LARGE_DTO VARBINARY(MAX));
...
CREATE TABLE NO_ID (VALUE1 ＩINT, VALUE2 INT);
