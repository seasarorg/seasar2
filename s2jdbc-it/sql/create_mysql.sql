...
CREATE TABLE LARGE_OBJECT(ID NUMERIC(8) NOT NULL PRIMARY KEY, NAME VARCHAR(10), LARGE_NAME TEXT, BYTES VARBINARY(2000), LARGE_BYTES BLOB, DTO VARBINARY(2000), LARGE_DTO BLOB);
