...
CREATE TABLE LARGE_OBJECT(ID NUMERIC(8) NOT NULL PRIMARY KEY, NAME VARCHAR(10), LARGE_NAME CLOB, BYTES RAW(2000), LARGE_BYTES BLOB, DTO RAW(2000), LARGE_DTO BLOB);
...
CREATE TABLE JOB (ID NUMERIC NOT NULL PRIMARY KEY, JOB_TYPE VARCHAR(20));
