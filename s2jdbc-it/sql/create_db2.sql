...
CREATE TABLE LARGE_OBJECT(ID NUMERIC(8) NOT NULL PRIMARY KEY, NAME VARCHAR(10), LARGE_NAME CLOB, BYTES VARCHAR(1000) FOR BIT DATA, LARGE_BYTES BLOB, DTO VARCHAR(1000) FOR BIT DATA, LARGE_DTO BLOB)@
