...
CREATE TABLE DEPARTMENT(DEPARTMENT_ID INTEGER NOT NULL PRIMARY KEY, DEPARTMENT_NO NUMERIC(2) NOT NULL,DEPARTMENT_NAME VARCHAR(20),LOCATION VARCHAR(20) DEFAULT 'TOKYO', VERSION INTEGER)@
...
CREATE TABLE COMP_KEY_DEPARTMENT(DEPARTMENT_ID1 INTEGER NOT NULL, DEPARTMENT_ID2 INTEGER NOT NULL, DEPARTMENT_NO NUMERIC(2) NOT NULL,DEPARTMENT_NAME VARCHAR(20),LOCATION VARCHAR(20) DEFAULT 'TOKYO', VERSION INTEGER, CONSTRAINT PK_DEPT PRIMARY KEY(DEPARTMENT_ID1, DEPARTMENT_ID2))@
...
CREATE TABLE LARGE_OBJECT(ID INTEGER NOT NULL PRIMARY KEY, BLOB_VALUE BLOB, CLOB_VALUE CLOB)@
