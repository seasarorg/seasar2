...
/**
 * @author koichik
 * @see org.seasar.extension.dxo.builder.impl.AbstractDxoCommandBuilderTigerTest
 */
public class AbstractDxoCommandBuilderTest extends TestCase {

    public void testGetElementTypeOfListFromParameterType() throws Exception {
        assertNull(AbstractDxoCommandBuilder
