...
public class ArrayMapTest extends TestCase {
	...
	public ArrayMapTest(String name) {
		super(name);
	}
	...
	public void testPerformance() throws Exception {
		...
		System.out.println(
			"ArrayMap.put:" + (System.currentTimeMillis() - start));
		...
		System.out.println(
			"ArrayMap.get:" + (System.currentTimeMillis() - start));
		...
		System.out.println(
			"HashMap iteration:" + (System.currentTimeMillis() - start));
		...
		System.out.println(
			"ArrayMap iteration:" + (System.currentTimeMillis() - start));

		start = System.currentTimeMillis();
		SerializeUtil.serialize(hmap);
		System.out.println(
			"HashMap serialize:" + (System.currentTimeMillis() - start));

		start = System.currentTimeMillis();
		SerializeUtil.serialize(amap);
		System.out.println(
			"ArrayMap serialize:" + (System.currentTimeMillis() - start));
	}
	...
	public static Test suite() {
		return new TestSuite(ArrayMapTest.class);
	}

	public static void main(String[] args) {
		junit.textui.TestRunner.main(
			new String[] { ArrayMapTest.class.getName()});
	}
