 ...
 * @author shot
 */
public class ConverterOndemandCreator extends SinglePackageOndemandCreator {

    public ConverterOndemandCreator(NamingConvention namingConvention) {
        super(namingConvention);
        setMiddlePackageName(namingConvention.getConverterPackageName());
