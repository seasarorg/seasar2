 ...
 * 
 */
public class MultiPackageOndemandCreatorTest extends S2FrameworkTestCase {
    ...
    protected void setUp() {
        ...
        MultiPackageOndemandCreator creator = new MultiPackageOndemandCreator(convention);
