...
import org.seasar.framework.container.hotdeploy.creator.ServiceComponentFilter;
 ...
 * 
 */
public class ServiceComponentFilterTest extends S2FrameworkTestCase {
    ...
    protected void setUp() {
        ...
        ondemand.addComponentFilter(new ServiceComponentFilter());
    ...
    public void testIsTargetByClass() throws Exception {
        Class clazz = ClassUtil.forName(ClassUtil.getPackageName(getClass()) + ".web.aaa.HogeService");
