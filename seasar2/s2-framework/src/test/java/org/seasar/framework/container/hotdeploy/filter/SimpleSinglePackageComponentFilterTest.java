 ...
 * 
 */
public class SimpleSinglePackageComponentFilterTest extends S2FrameworkTestCase {
    ...
    protected void setUp() {
        ...
        SimpleSinglePackageComponentFilter filter = new SimpleSinglePackageComponentFilter();
